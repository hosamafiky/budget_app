import 'package:budget_app/config/data.dart';
import 'package:budget_app/helpers/helpers.dart';
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text(
                  '\$${(category.maxAmount - totalAmountSpent).toStringAsFixed(2)}/\$${category.maxAmount.toString()}',
                  style: TextStyle(
                    fontSize: 18.0,
                    fontWeight: FontWeight.w600,
                    letterSpacing: -1.2,
